...
public final class RCallerPoolableObjectFactory
    ...
    public void passivateObject(final RCaller obj) throws Exception {
        ...
        obj.getRCode().addRCode(CliScriptTaskRunnerPython.INTERNAL_RESULT_VARIABLE + " <- c()");
        obj.runAndReturnResultOnline(CliScriptTaskRunnerPython.INTERNAL_RESULT_VARIABLE);
        obj.deleteTempFiles();
    }
