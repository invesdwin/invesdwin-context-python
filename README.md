...
- **invesdwin-context-python-runtime-graalpy**: This runtime uses [GraalPy]([http://www.jython.org/](https://www.graalvm.org/python/)) as a pure JVM implementation of python. It faster than Jython and is more up-to-date. You can sideload python modules from a zipped GraalPy virtual environment following this [guide](https://github.com/graalvm/graal-languages-demos/blob/main/graalpy/graalpy-custom-venv-guide/README.md#42-custom-virtual-environment).
Currently the module provides the following system properties:
```properties
